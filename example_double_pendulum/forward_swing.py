...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Double pendulum forward swing (toward +X) example.")
    p.add_argument(
        "--model",
    ...
    p.add_argument(
        ...
        type=float,
        default=2.0,
        help="Initial hinge1 velocity (rad/s). Positive tends to start motion toward +X.",
    )
