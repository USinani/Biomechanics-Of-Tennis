...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Free-swinging double pendulum under gravity.")
    p.add_argument(
        "--model",
    ...
    p.add_argument("--q1", type=float, default=0.6, help="Initial hinge1 angle (rad).")
    p.add_argument("--q2", type=float, default=-0.2, help="Initial hinge2 angle (rad).")
    p.add_argument("--qd1", type=float, default=0.0, help="Initial hinge1 velocity (rad/s).")
